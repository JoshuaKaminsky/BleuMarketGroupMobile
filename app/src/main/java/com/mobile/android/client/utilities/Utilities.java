...
public class Utilities {	
	...
	public static Bitmap getBitmap(ImageView view) {
	    ...
	    return ((BitmapDrawable)drawing).getBitmap();
	}
	
	public static Bitmap scaleImage(Bitmap bitmap, int max, Context context)
	{
	    // Get current dimensions AND the desired bounding box
	    int width = bitmap.getWidth();
	    int height = bitmap.getHeight();
	    int bounding = dpToPx(context, max);
    ...
    public static void tryDeleteFile(String filename, Context context) {
